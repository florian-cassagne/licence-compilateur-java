...
public class Identificateurs {
    ...
    public static void genererTableauIdentificateurs(){
        ...
        for(int i = 0; i < TableLexicale.unitesLexicales.size() ; i++) {
            ArrayList<Object> record = new ArrayList<>();
            record.add(TableLexicale.unitesLexicales.get(i).get(0));
            record.add(TableLexicale.unitesLexicales.get(i).get(1));
            if((TableLexicale.unitesLexicales.get(i).get(1) == Type.ident) &&
                    (Identificateurs.chercher((String) TableLexicale.unitesLexicales.get(i).get(0))) == -1){
